...
// Mock Database State
let users: User[] = [
  { uid: 'user_1', email: 'admin1234@gmail.com', displayName: 'John Pastor', role: 'admin', password: 'admin1234' },
...
let accounts: Account[] = [
  { id: '1', userId: 'user_1', type: 'checking', number: '**** 4291', balance: 12450.75, currency: 'USD', name: 'John Pastor (Checking)', creditLimit: 2000, status: 'active', depositRestricted: false, createdAt: '2025-11-15T08:00:00.000Z', flagged: false },
  { id: '2', userId: 'user_1', type: 'savings', number: '**** 8820', balance: 45200.00, currency: 'USD', name: 'John Pastor (Savings)', creditLimit: 5000, status: 'active', depositRestricted: false, createdAt: '2025-11-15T08:05:00.000Z', flagged: false },
  { id: '3', userId: 'user_2', type: 'checking', number: '**** 3314', balance: 8430.20, currency: 'USD', name: 'Sarah Jenkins', creditLimit: 10000, status: 'active', depositRestricted: false, createdAt: '2026-01-20T10:00:00.000Z', flagged: false },
  { id: '4', userId: 'user_3', type: 'savings', number: '**** 1234', balance: 3200.50, currency: 'USD', name: 'David Smith', creditLimit: 1500, status: 'active', depositRestricted: false, createdAt: '2026-03-10T14:30:00.000Z', flagged: false }
];
...
function loadDb() {
  try {
    ...
    // Ensure admin user password is set to admin1234
...
async function startServer() {
  ...
  app.patch("/api/admin/accounts/:id", (req, res) => {
    const { id } = req.params;
    const { balance, name, creditLimit, status, depositRestricted, createdAt, flagged } = req.body;
  ...
  // Admin: Edit Transaction (date, description, amount, category, status)
  ...
  // Admin: Toggle account flagged status
  app.patch("/api/admin/accounts/:id/flag", (req, res) => {
    const { id } = req.params;
  ...
  // Admin: Update account creation date
  app.patch("/api/admin/accounts/:id/date", (req, res) => {
    const { id } = req.params;
