        ...
        <div className="p-8">
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              {accounts.find(a => a.id === fromId)?.status === 'disabled' && (
                <p className="text-[10px] text-red-500 font-bold mt-1">This account is disabled. Select another.</p>
              )}
              {accounts.find(a => a.id === fromId)?.flagged && (
                <p className="text-[10px] text-amber-500 font-bold mt-1">Flagged account — transfers may be restricted.</p>
              )}
            </div>
